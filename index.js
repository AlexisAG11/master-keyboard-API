...
const contentTextReAsking = "This time can you give me new words : 10 easy words to write, 10 difficult words to write, 10 medium difficulty words and format them in a JSON with only JSON data no useless text and the name of the array are 'easy', 'medium', 'difficult'";
